...
const categories = [
  {id:1,name:'Pièces Mécaniques et Electriques'},
  {id:2,name:'Carrosserie et Optiques'},
  {id:3,name:'Vitre et Parebrises'},
  {id:4,name:'Pneumatique'},
];
const brands = [
  {id:1,name:'PEUGEOT / RENAULT / CITROEN / DACIA'},
  {id:2,name:'GROUPE VAG'},
  {id:3,name:'FORD / OPEL'},
  {id:4,name:'TOYOTA / NISSAN / MITSUBISHI / DAIHASU'},
  {id:1,name:'KIA / HYUNDAI / SUZUKI / CHEVROLET / DFM / CHERRY'},
  {id:2,name:'FIAT'},
  {id:3,name:'TATA / MAHINDRA'},
  {id:4,name:'ASIATIQUES'},
];
